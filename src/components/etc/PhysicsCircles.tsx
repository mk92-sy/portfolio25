        ...
        return (
          <div
            ...
            style={{
              ...
              borderRadius: '50%',
              background:
                'radial-gradient(circle at 30% 30%, rgba(255,255,255,0.8), rgba(173,216,230,0.3), rgba(0,0,0,0))',
              boxShadow:
                'inset 0 0 10px rgba(255,255,255,0.5), 0 0 15px rgba(173,216,230,0.4), 0 0 30px rgba(255,255,255,0.2)',
